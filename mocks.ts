...
export const MOCK_USERS: User[] = [
    ...
    {
        id: 'admin-1', name: 'Admin', level: 999, imageUrl: 'https://ui-avatars.com/api/?name=A&background=1e293b&color=fff&bold=true', achievements: [], role: UserRole.Admin, gender: 'male'
    }
];
