...
const App: React.FC = () => {
  ...
  const renderAuthenticatedContent = () => {
      ...
      switch(user.role) {
          case UserRole.Admin:
              return <AdminDashboard user={user} onLogout={handleLogout} enabledModules={enabledModules} setEnabledModules={setEnabledModules} customModules={customModules} setCustomModules={setCustomModules} theme={theme} onToggleTheme={handleToggleTheme} />;
